...
def cmdLineParser(argv=None):
    ...
    try:
        ...
        target.add_argument("--openapi", dest="openapi",
            help="Load targets from OpenAPI/Swagger specification file or URL")
        ...
        if not any((args.direct, args.url, args.logFile, args.bulkFile, args.googleDork, args.configFile, args.requestFile, args.updateAll, args.smokeTest, args.vulnTest, args.wizard, args.dependencies, args.purge, args.listTampers, args.hashFile, args.stdinPipe, args.openapi)):
            errMsg = "missing a mandatory option (-d, -u, -l, -m, -r, -g, -c, --openapi, --wizard, --shell, --update, --purge, --list-tampers or --dependencies). "
